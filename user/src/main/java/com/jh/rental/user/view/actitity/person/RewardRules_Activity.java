 ...
 */
@EActivity(R.layout.rewardrules_activity)
public class RewardRules_Activity extends TitelBarAcitvity{
    @ViewById(R.id.wv_agreement)
    WebView webView;
    @AfterViews
    public void afterview(){
        setMyTitel(BaseContext.getResValue(R.string.RewardRules));
    ...
    private void initView() {
        ...
        new HotCircuitUrlTpye().reqNet(5, new HotCircuitUrlTpye.CallBackUrl() {
            @Override
