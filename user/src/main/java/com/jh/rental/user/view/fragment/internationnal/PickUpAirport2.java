 ...
 */
public class PickUpAirport2 extends com.jh.rental.user.view.fragment.BaseFragment implements View.OnClickListener {
    ...
    protected void init(View view) {
        ...
        pickup_tv2.setText(BaseContext.getResValue(R.string.start));
    }
