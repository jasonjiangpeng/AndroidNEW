...
public class DestinationLeftAdapter extends BaseAdapter   {

    private   Context context;
    private   List<String> lists;


    public DestinationLeftAdapter(Context context, String[] str) {
        this(context,Arrays.asList(str));

    }
    public DestinationLeftAdapter(Context context, List<String> lists) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            convertView=LayoutInflater.from(context).inflate(R.layout.sub_item_textview,parent, false);
