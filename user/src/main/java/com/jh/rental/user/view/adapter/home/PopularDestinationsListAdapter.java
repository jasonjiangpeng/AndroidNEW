 ...
 *  @文件名:   PopularDestinationsListAdapter
 *  @创建者:   ThinkPad
 *  @创建时间:  2017/5/21 22:55
 *  @描述：    TODO
 */
public class PopularDestinationsListAdapter
        extends RecyclerView.Adapter<PopularDestinationsListAdapter.PopularDestinationsListItemViewHolder> {

    private static final String TAG = "PopularDestinationsListAdapter";
    private final Context                mContext;

    public PopularDestinationsListAdapter(Context context) {
        mContext = context;
    }
